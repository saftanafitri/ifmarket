...
@section('title', 'Sakti Produk - Manage Produk')
...
@section('content')
    <section class="py-5">
        ...
        <style>
            .product-img {
                width: 120px; /* Atur ukuran lebar */
                height: 80px; /* Atur ukuran tinggi */
                object-fit: cover; /* Pastikan gambar tidak terdistorsi */
                border-radius: 5px; /* Opsional: Sudut sedikit melengkung */
            }
        </style>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            @if($product->photos->isNotEmpty())
                                <img src="{{ asset($product->photos->first()->url) }}" 
                                     alt="{{ $product->name }}" 
                    ...
                    <td>
                        ...
                        <!-- Tombol Hapus (Trigger SweetAlert2) -->
